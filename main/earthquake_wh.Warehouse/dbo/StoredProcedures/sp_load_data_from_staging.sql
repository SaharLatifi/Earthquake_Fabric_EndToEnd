CREATE  PROCEDURE sp_load_data_from_staging 
...
INSERT INTO fact_earthquake
    (earthquake_id ,title,place_description,sig,mag,mag_type_id,sig_class_id,country_id,earthquake_datetime, earthquake_date,created_at, last_updated_at)
SELECT 
    v.earquake_id ,
    v.title,
    v.place_description,
